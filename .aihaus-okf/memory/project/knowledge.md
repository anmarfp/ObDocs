...
- 2026-08-30 — DOC-28 subtask 1/5 (ADR-009): documented the `Agent(isolation: "worktree")` stale-base gotcha and a pre-existing flaky date-dependent test in `notification-gcal.test.ts`.
